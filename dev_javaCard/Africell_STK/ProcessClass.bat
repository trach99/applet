...
set JC_31_HOME=%JC_KIT%\java_card_kit-3.1
...
set SELECT_CONV=221
    echo *****************************************************
IF %SELECT_CONV%==211 (
	echo *select converter 2.1.1                             *
	set JC_CLASSPATH="%JC_211_HOME%\lib\*;%JC_CLASSPATH%"
	set JC_CLASSIC_HOME=%JC_211_HOME%
)ELSE IF %SELECT_CONV%==212 (
	...
	set CONVERTER_CLASSNAME=com.sun.javacard.converter.Main
)ELSE IF %SELECT_CONV%==31 (
	echo *select converter 3.1                             *
	set JC_CLASSPATH="%JC_31_HOME%\lib\*;%JC_CLASSPATH%"
	set JC_CLASSIC_HOME=%JC_31_HOME%
	set JAVA_HOME=%JC_LIB%\javaHome\jre7
	set CONVERTER_CLASSNAME=com.sun.javacard.converter.Main
